...
export const youngerFuthark: { [key: string]: string } = {
  'a': 'ᛅ', 'b': 'ᛒ', 'c': 'ᚴ', 'd': 'ᛏ', 'e': 'ᛁ', 'f': 'ᚠ',
  'g': 'ᚴ', 'h': 'ᚼ', 'i': 'ᛁ', 'j': 'ᛁ', 'k': 'ᚴ', 'l': 'ᛚ',
  'm': 'ᛘ', 'n': 'ᚾ', 'o': 'ᚬ', 'p': 'ᛒ', 'q': 'ᚴ', 'r': 'ᚱ',
  's': 'ᛋ', 't': 'ᛏ', 'u': 'ᚢ', 'v': 'ᚢ', 'w': 'ᚢ', 'x': 'ᚴᛋ',
  'y': 'ᛁ', 'z': 'ᛋ', ' ': '᛫',
};

export const shortTwigFuthark: { [key: string]: string } = {
  'a': 'ᛆ', 'b': 'ᛓ', 'c': 'ᚴ', 'd': 'ᛐ', 'e': 'ᛁ', 'f': 'ᚠ',
  'g': 'ᚴ', 'h': 'ᚽ', 'i': 'ᛁ', 'j': 'ᛁ', 'k': 'ᚴ', 'l': 'ᛚ',
  'm': 'ᛙ', 'n': 'ᚿ', 'o': 'ᚭ', 'p': 'ᛓ', 'q': 'ᚴ', 'r': 'ᚱ',
  's': 'ᛌ', 't': 'ᛐ', 'u': 'ᚢ', 'v': 'ᚢ', 'w': 'ᚢ', 'x': 'ᚴᛌ',
  'y': 'ᛁ', 'z': 'ᛌ', ' ': '᛫',
};

export const stavelessFuthark: { [key: string]: string } = {
  'a': '⸝', 'b': 'ި', 'c': 'ᛍ', 'd': '⸍', 'e': 'ᛁ', 'f': 'ᛙ',
  'g': 'ᛍ', 'h': 'ᚽ', 'i': 'ᛁ', 'j': 'ᛁ', 'k': 'ᛍ', 'l': '⸌',
  'm': '⠃', 'n': '⸜', 'o': 'ˎ', 'p': 'ި', 'q': 'ᛍ', 'r': '◟',
  's': '╵', 't': '⸍', 'u': '╮', 'v': '╮', 'w': '╮', 'x': 'ᛍ╵',
  'y': 'ᛁ', 'z': '╵', ' ': '᛫',
};

export const medievalRunerow: { [key: string]: string } = {
  'a': 'ᛆ', 'b': 'ᛒ', 'c': 'ᛌ', 'd': 'ᛑ', 'e': 'ᛂ', 'f': 'ᚠ',
  'g': 'ᚵ', 'h': 'ᛡ', 'i': 'ᛁ', 'j': 'ᛁ', 'k': 'ᚴ', 'l': 'ᛚ',
  'm': 'ᛉ', 'n': 'ᚿ', 'o': 'ᚮ', 'p': 'ᛔ', 'q': 'ᚴ', 'r': 'ᚱ',
  's': 'ᛍ', 't': 'ᛐ', 'u': 'ᚢ', 'v': 'ᚡ', 'w': 'ᚡ', 'x': 'ᚴᛍ',
  'y': 'ᚤ', 'z': 'z', ' ': '᛫',
};

export const angloSaxonFuthark: { [key: string]: string } = {
  'a': 'ᚪ', 'b': 'ᛒ', 'c': 'ᚳ', 'd': 'ᛞ', 'e': 'ᛖ', 'f': 'ᚠ',
  'g': 'ᚷ', 'h': 'ᚻ', 'i': 'ᛁ', 'j': 'ᛄ', 'k': 'ᚳ', 'l': 'ᛚ',
  'm': 'ᛗ', 'n': 'ᚾ', 'o': 'ᚩ', 'p': 'ᛈ', 'q': 'ᚳ', 'r': 'ᚱ',
  's': 'ᛋ', 't': 'ᛏ', 'u': 'ᚢ', 'v': 'ᚠ', 'w': 'ᚹ', 'x': 'ᚳᛋ',
  'y': 'ᛁ', 'z': 'ᛋ', ' ': '᛫',
};
